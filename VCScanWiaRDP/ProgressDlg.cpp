...
DWORD WINAPI CProgressDlg::ThreadProc(PVOID pParameter)
{
	...
	//HWND hWndDlg = CreateDialogParam(g_hInstance, MAKEINTRESOURCE(IDD_PROGRESS), 
	//	g_hWndMstsc, DialogProc, (LPARAM)that);
	//if (hWndDlg != NULL)
	//{
	//	ShowWindow(hWndDlg, SW_SHOW);
	//	SetWindowPos(hWndDlg, HWND_TOP, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE | SWP_ASYNCWINDOWPOS | SWP_SHOWWINDOW);
	//}
